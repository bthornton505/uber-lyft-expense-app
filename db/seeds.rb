...
Expense.create(month: 'December', cost: 45, category_id: 5, expense_report_id: 2)
...
Expense.create(month: 'January', cost: 1800, category_id: 4, expense_report_id: 3)
...
Expense.create(month: 'February', cost: 45, category_id: 5, expense_report_id: 4)
...
Expense.create(month: 'March', cost: 35, category_id: 7, expense_report_id: 5)
...
Comment.create(description: 'Total spent on car washes', expense_id: 7)

Comment.create(description: 'Gas for the month', expense_id: 8)
Comment.create(description: 'Paid to Suntrust Bank', expense_id: 9)
Comment.create(description: 'Geico payment', expense_id: 10)
Comment.create(description: 'Took the car in to get repaired', expense_id: 11)

Comment.create(description: 'Gas for the month', expense_id: 12)
Comment.create(description: 'Paid to Suntrust Bank', expense_id: 13)
Comment.create(description: 'Geico payment', expense_id: 14)
Comment.create(description: 'Total spent on car washes', expense_id: 15)

Comment.create(description: 'Gas for the month', expense_id: 16)
Comment.create(description: 'Paid to Suntrust Bank', expense_id: 17)
Comment.create(description: 'Geico payment', expense_id: 18)
Comment.create(description: 'Bought some cleaning supplies for the car', expense_id: 19)
